...
const Hero = ({ titleData, createCampaign }) => {
  ...
  return (
    ...
    auto-compress&amp;cs=tinys rgb&amp;dpr=2&amp;h=750&amp;w=1260"
                ...
                <form>
                  ...
                  <div className="mb-1 sm:mb-2">
                    ...
                    <input
                      ...
                      required
                      type="text"
                      className="flex-grow w-full h−12 px-4 mb-2 transition duration-200 bg-white border border-gray-300 rounded shadow appearance-none focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
                      id="firstName"
                      name="firstName"
                    />
                  </div>
                  ...
                  <div className="mt-4 mb-2 sm:mb-4">
                    <button
                      ...
                      type="submit"
                      className="inline-flex items-center justify-center w-full h-12 px-6 font-semibold tracking-wide text-black transition duration-200 ounded shadow-md bg-deep-blue-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none newColor"
                      >
                        Create Campaign
                      </button>
                  </div>
